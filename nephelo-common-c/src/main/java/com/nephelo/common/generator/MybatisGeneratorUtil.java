package com.nephelo.common.generator;

import com.nephelo.common.util.AESUtil;
import com.nephelo.common.util.JdbcUtil;
import com.nephelo.common.util.StringUtil;
...
import static com.nephelo.common.util.StringUtil.lineToHump;

/**
 * 代码生成类
 * Created by nephelo on 2017/1/10.
 */
public class MybatisGeneratorUtil {
	...
	public static void generator(
		...
		for (int i = 0; i < tables.size(); i++) {
			...
			String serviceMock = serviceImplPath + "/" + model + "ServiceMock.java";
