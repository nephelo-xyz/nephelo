...
import com.nephelo.consumer.filter.CodeUsernamePasswordAuthenticationFilter;
import com.nephelo.consumer.filter.CorsFilter;
import com.nephelo.consumer.service.impl.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/", "/nephelo-user/v1/tUser/register").permitAll()
